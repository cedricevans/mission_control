...
function PremiumHeader({
  ...
  return <motion.header initial={{
    ...
    y: 0,
    opacity: 1
  }} className="h-16 border-b border-[var(--border-color)] bg-[var(--primary-bg)]/90 backdrop-blur-md flex items-center justify-between px-4 md:px-8 z-50 sticky top-0 transition-colors duration-300">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" className="md:hidden text-[var(--text-primary)] hover:bg-[var(--hover-bg)]" onClick={onMenuClick}>
